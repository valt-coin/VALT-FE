    ...
    <div className="w-full flex flex-col text-[#777E90]">
      <div className="w-full flex flex-row py-4 justify-center items-center">
        <div className="flex xs:flex-col xs:w-[150px] my-[10px] sm:mt-2 xs:gap-y-2">
          ...
          <button
            onClick={Organizersbutton}
            className="block justify-center text-black bg-[#58BD7D] rounded-[14px] w-[150px] xs:w-full items-center hover:bg-[#58BD7D] hover:text-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#c6e6d2]"
          >
            <p className="text-lg xs:text-[14px] font-bold ">Organizers</p>
          </button>
          <button
            onClick={Reportbutton}
            className="block justify-center bg-transparent rounded-[14px] w-[110px] xs:w-full items-center text-grayColor hover:bg-[#58BD7D] hover:text-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#c6e6d2]"
          >

  ...
  return (
    <div className="w-full flex flex-col xs:pt-4 sm:pt-8 md:pt-14 lg:pt-20">
      <div className="w-full border border-grayBackgroundColor border-x-[0px] text-gray-500">
        <div className="w-full py-8 sm:py-6 xs:px-4 sm:px-8 md:px-16 lg:px-40 flex sm:flex-col sm:items-center sm:gap-y-[21px] justify-between sm:justify-center">
          ...
          <button
            ...
            className="w-[160px] h-[60px] xs:w-[120px] xs:h-[40px] flex justify-center items-center border-[2px] border-grayColor rounded-full text-white text-4 xs:text-[14px] font-bold cursor-pointer
